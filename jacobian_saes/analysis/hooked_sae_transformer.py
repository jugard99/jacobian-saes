...
class HookedSAETransformer(HookedTransformer):
    ...
    def __init__(
        ...
        **model_kwargs: Any,
        ...
        self.acts_to_saes: Dict[str, SAEPair] = {}

    def add_sae(self, sae: SAEPair, use_error_term: Optional[bool] = None):
    ...
    def _reset_sae(self, act_name: str, prev_sae: Optional[SAEPair] = None):
    ...
    def reset_saes(
        ...
        prev_saes: Optional[List[Union[SAEPair, None]]] = None,
    ):
    ...
    def run_with_saes(
        self,
        *model_args: Any,
        saes: Union[SAEPair, List[SAEPair]] = [],
