...
for experiment_name in ["detection", "fuzz"]:
    dir_name = f"results/autointerp/scores/{experiment_name}"
    all_data: list[bool] = {}
    ...
    with open(f"results/autointerp/scores/{experiment_name}_results.json", "w") as f:
